...
public class Base64 {
    ...
    public static String encode(byte[] byteData) {
        ...
        return new String(_encode(byteData), StandardCharsets.UTF_8);
    }
    ...
    public static byte[] encode(String string) {
        ...
        return _encode(string.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static String decode(byte[] encoded) {
        ...
        return new String(_decode(encoded), StandardCharsets.UTF_8);
    }
    ...
    public final static byte[] decode(String encoded) {
        ...
        return _decode(encoded.getBytes(StandardCharsets.UTF_8));
    }
