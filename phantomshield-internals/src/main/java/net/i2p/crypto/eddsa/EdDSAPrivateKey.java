 ...
 *      specification</a>
 */
public class EdDSAPrivateKey implements EdDSAKey {
    ...
    public EdDSAPrivateKey(byte[] spec) throws InvalidKeySpecException {
        this(new EdDSAPrivateKeySpec(decode(spec),
