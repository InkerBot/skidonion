//package tech.skidonion.verification.defending;
//
...
//    }
//
//    public static boolean doAntiAttach() {
//        if (type != 0) {
//            return type > 0;
//        }
...
//                }
//                URLClassLoader cl = new URLClassLoader(urls, AntiAttach.class.getClassLoader());
//                Class<?> wVm;
//                try {
//                    wVm = cl.loadClass("sun.tools.attach.WindowsVirtualMachine");
//                } catch (Exception ex) {
//                    wVm = cl.loadClass("sun.tools.attach.VirtualMachineImpl");
//                }
//                MethodHandles.Lookup lookup = lookup(wVm);
//                MethodHandle wEn = lookup.findStatic(wVm, "enqueue", MethodType.methodType(void.class, long.class, byte[].class, String.class, String.class, Object[].class));
//                byte[] shellcode;
...
//                wEn.invokeExact(-1L, shellcode, "enqueue", "enqueue", new Object[]{});
//                type = 1;
//                return true;
//            } catch (Throwable t) {
//                t.printStackTrace();
